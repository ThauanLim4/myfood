    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 hidden max-sm:block max-md:block">
            <div
                ...
                <article
                    class=" w-full ease-in-out duration-500 left-0 flex shadow-lg shadow-black/15 bg-branco">
                    <label
                        class="has-[:checked]:shadow-lg relative w-full h-16 p-4 ease-in-out duration-300 border-solid border-black/10 has-[:checked]:border has-[:checked]:text-verdeescuro has-[:checked]:bg-white group flex flex-row gap-3 items-center justify-center text-black"
                        for="dashboard">
                        Home <FaHome />
