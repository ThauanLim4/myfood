...
export const FoodComponentInstore = ({ variableName }) => {
    return (
        <div className="mt-10 mb-16">
            <div className="grid grid-cols-2 max-w-screen-lg mx-auto max-md:grid-cols-2 gap-5">
                {
                    variableName.map((it, ind) => {
                        return (
                            <div key={ind} className="flex flex-col max-sm:border-2 rounded-lg border-gray-500/25 gap-5 hover:shadow-sombra cursor-pointer w-full max-w-96 h-32max-h-36 mx-auto p-2">
                                <div className="flex flex-col justify-center gap-1">
